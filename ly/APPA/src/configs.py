...
class Config(object):
    ...
    def __init__(self):
        # 数据路径
        self.data_train_path = '/root/ly/APPA/dataset/Small/data_code_train_'
        self.data_test_path = '/root/ly/APPA/dataset/Small/data_code_test_'
        # 模型保存路径
        self.model_save_path = './output/bert_small_mix_head_012/'
...
#        self.splicingMethod = 'mean_pooling'
...
#        self.model_path = 'microsoft/graphcodebert-base'
        ...
        self.pretrained_model_path = '/root/ly/CL_pretrain/output/checkpoint1'
        # bert 是否冻结
