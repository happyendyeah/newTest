...
class Config(object):
    ...
    def __init__(self):
        # 数据路径
        self.data_train_path = '/root/ly/APPA/dataset/data_new_transformed_diff_project/data_new2000T_code_diff_project_train_'
        self.data_test_path = '/root/ly/APPA/dataset/data_new_transformed_diff_project/data_new2000T_code_diff_project_test_'
        # 模型保存路径
        self.model_save_path = './output/bert/codebert_new2000T_diff/'
...
#        self.splicingMethod = 'max_pooling'
...
#        self.model_path = 'microsoft/graphcodebert-base'
        ...
        self.pretrained_model_path = '/ly/DACL/output/bert/contrastive_rule3_bert_0/checkpoint49'
        # bert 是否冻结
