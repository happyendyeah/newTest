...
class Config(object):
    ...
    def __init__(self):
        # 数据路径
        self.data_train_path = '/root/ly/CL_pretrain/dataset/hxd_java_rule_random_'
        self.data_test_path = '/root/ly/CL_pretrain/dataset/data_test_'
        # 模型保存路径
        self.model_save_path = './output/codebert_pretrained'
